...
# 2. http://www.fightprior.com/2016/08/11/Building_mySQL_fight_db/
# 3. https://bioconductor.org/packages/devel/bioc/vignettes/Organism.dplyr/inst/doc/Organism.dplyr.html
# 4. http://csjp.users.sonic.net/SEQUELFun.html
